...
export default function Konvert() {
  ...
  return <Main title='變換'>
    <div style={{ display: 'grid', gap: '1ex', gridTemplateColumns: '1fr 1fr' }}>
      <textarea style={{ blockSize: '8ex', font: 'inherit', borderColor: 'currentColor' }}
        onInput={(event) => {
          setTranslated(translate((event.target as HTMLTextAreaElement).value));
        }} />
      <textarea style={{ blockSize: '8ex', font: 'inherit', borderColor: 'currentColor' }} value={translated} readOnly />
